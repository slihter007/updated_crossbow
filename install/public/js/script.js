...
$(window).on('load', function() {
    ...
    var browse  = $('#browse');
    message.html('<i class="fa fa-cog fa-spin"></i> Please Wait...<br><p style="font-size:15px;">We\'re preparing your own Crossbow for your Business.</p>');
    setInterval(function () { 
        message.html('<i class="fa fa-check"></i> Install Successfully!<br><p style="font-size:15px;">Yehey! Your account has been set, you can now login to your crossbow account.</p>');
