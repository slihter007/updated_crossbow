...
<div class="ciuis-body-content" ng-controller="Leads_Controller">
      ...
      <div class="panel-default panel-table borderten lead-manager-head">
        <div class="col-md-4 col-xs-4 border-right" style="margin-bottom: 10px;border-bottom: 2px dashed #cecece;padding-bottom: 20px;">
          <div class="tasks-status-stat">
            ...
            <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: 40%;"></span> </span> </div>
          <span style="color:#989898"><?php echo lang('converted') ?></span> </div>
        <div class="col-md-4 col-xs-4 border-right" style="margin-bottom: 10px;border-bottom: 2px dashed #cecece;padding-bottom: 20px;">
          <div class="tasks-status-stat">
            ...
            <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: 40%;"></span> </span> </div>
          <span style="color:#989898"><?php echo lang('junk') ?></span> </div>
        <div class="col-md-4 col-xs-4 border-right" style="margin-bottom: 10px;border-bottom: 2px dashed #cecece;padding-bottom: 20px;">
          <div class="tasks-status-stat">
            ...
            <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: 40%;"></span> </span> </div>
          <span style="color:#989898"><?php echo lang('lost') ?></span> </div>
          ...
          <div class="widget-counter-group widget-counter-group-right">
            <div style="width: auto" class="pull-left"> <i style="font-size: 38px;color: #bfc2c6;margin-right: 10px" class="ion-stats-bars pull-left"></i>
              <div class="pull-right" style="text-align: left;margin-top: 10px;line-height: 10px;">
                ...
                <small><?php echo lang('leadstatsbysource') ?></small> </div>
            </div>
          </div>
          <div class="my-2">
    ...
    <div class="main-content container-fluid col-xs-12 col-md-9 col-lg-9 md-p-0 lead-table">
      <md-toolbar class="toolbar-white">
        <div class="md-toolbar-tools">
          <h2 flex md-truncate class="text-bold"><?php echo lang('leads'); ?><br>
            <small flex md-truncate><?php echo lang('leaddesc'); ?></small></h2>
          ...
          <md-menu md-position-mode="target-right target" ng-hide="ONLYADMIN != 'true'">
            ...
            <md-menu-content width="4">
              ...
              <md-menu-item>
                <md-button ng-href="<?php echo base_url('leads/forms')?>">
                  <div layout="row" flex>
                    <p flex><?php echo lang('webleads') ?></p>
                    <md-icon md-menu-align-target class="ion-earth" style="margin: auto 3px auto 0;"></md-icon>
                  </div>
                </md-button>
              </md-menu-item>
            </md-menu-content>
      ...
      <md-content ng-show="!leadsLoader" ng-if="KanbanBoard" class="ciuis_lead_kanban_board" style="padding: 0px">
        <md-list class="ciuis_lead_status_card" flex ng-repeat="lead_status in leadstatuses"  ui-on-Drop="onDrop($event,$data,lead_status.id)">
          <md-toolbar class="toolbar-white">
            <div class="md-toolbar-tools">
              <h2 flex md-truncate class="text-bold">{{lead_status.name}}</h2>
              <md-menu md-position-mode="target-right target" ng-hide="ONLYADMIN != 'true'">
                <md-button aria-label="Open demo menu" class="md-icon-button" ng-click="$mdMenu.open($event)">
                  <md-icon><i class="ion-android-more-vertical text-muted"></i></md-icon>
                </md-button>
                <md-menu-content width="4">
                  <md-menu-item>
                    <md-button ng-click="EditStatus(lead_status.id,lead_status.name, $event)">
                      <div layout="row" flex>
          ...
          <md-list-item class="md-3-line" ui-draggable="true" drag="lead" on-drop-success="dropSuccessHandler($event,$index,lead_status.id)" ng-repeat="lead in leads | filter: FilteredData | filter:search | filter: { status: lead_status.id}"> <img ng-src="<?php echo base_url('uploads/images/{{lead.avatar}}')?>" class="md-avatar" alt="{{lead.assigned}}" />
            <div class="md-list-item-text" layout="column">
              <h3>{{ lead.name }}</h3>
              <h4>{{ lead.assigned }}</h4>
              <p>{{ lead.phone }}</p>
              <md-button class="md-secondary md-icon-button" ng-click="GoLeadDetail($index)" aria-label="call">
                <md-icon class="mdi mdi mdi-info-outline"></md-icon>
              </md-button>
            </div>
      ...
      <md-content ng-show="!leadsLoader" ng-if="!KanbanBoard" class="md-pt-0">
            ...
            <ul class="list-item-for-custom-list">
              <li class="ciuis-custom-list-item-item col-md-12">
                ...
                <div class="pull-left col-md-6"><a ng-href="<?php echo base_url('leads/lead/')?>{{lead.id}}"><strong ng-bind="lead.name"></strong></a><br>
                  <small ng-bind="lead.company"></small> </div>
                <div class="col-md-6">
                  <div class="col-md-5"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('phone') ?> <i class="ion-ios-stopwatch-outline"></i></small><br>
                    <strong ng-bind="lead.phone"></strong></span> </div>
                  <div class="col-md-4"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('status') ?> <i class="ion-ios-circle-filled"></i></small><br>
                    <strong><span class="badge" style="border-color: #fff;background-color: {{lead.color}};" ng-bind="lead.statusname"></span></strong></span> </div>
                  <div class="col-md-3"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('source') ?> <i class="ion-ios-circle-filled"></i></small><br>
                    <strong><span class="badge" ng-bind="lead.sourcename"></span></strong></span> </div>
                </div>
              </li>
            </ul>
          </li>
        </ul>
        <div ng-hide="leads.length < 5" class="pagination-div">
          <ul class="pagination">
  ...
  <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Create">
    ...
    <md-content>
      <md-content layout-padding>
        ...
        <md-chips ng-model="tags" md-separator-keys="keys" placeholder="Lead Tags" secondary-placeholder="Seperate with comma."></md-chips>
        {{tags}}
      ...
      <md-content layout-padding>
        <section layout="row" layout-sm="column" layout-align="center center" layout-wrap>
          <md-button ng-click="AddLead()" class="template-button" ng-disabled="saving == true">
  ...
  <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Import">
    ...
    <md-content> <?php echo form_open_multipart('leads/import'); ?>
      ...
      <?php echo form_close(); ?> </md-content>
  </md-sidenav>
