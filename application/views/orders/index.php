...
<div class="ciuis-body-content" ng-controller="Orders_Controller">
    ...
    <div class="row" style="padding: 0px 20px 0px 20px;">
      <div class="col-md-6 col-xs-6 border-right">
        <div class="tasks-status-stat">
          ...
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{(orders | filter:{status_id:'1'}).length * 100 / orders.length }}%;"></span> </span> </div>
      ...
      <div class="col-md-6 col-xs-6 border-right">
        <div class="tasks-status-stat">
          ...
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{(orders | filter:{status_id:'2'}).length * 100 / orders.length }}%;"></span> </span> </div>
      ...
      <div class="col-md-6 col-xs-6 border-right">
        <div class="tasks-status-stat">
          ...
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{(orders | filter:{status_id:'3'}).length * 100 / orders.length }}%;"></span> </span> </div>
      ...
      <div class="col-md-6 col-xs-6 border-right">
        <div class="tasks-status-stat">
          ...
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{(orders | filter:{status_id:'4'}).length * 100 / orders.length }}%;"></span> </span> </div>
      ...
      <div class="col-md-6 col-xs-6 border-right">
        <div class="tasks-status-stat">
          ...
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{(orders | filter:{status_id:'5'}).length * 100 / orders.length }}%;"></span> </span> </div>
      ...
      <div class="col-md-6 col-xs-6 border-right">
        <div class="tasks-status-stat">
          ...
          <span class="ciuis-task-percent-bg"> <span class="ciuis-task-percent-fg" style="width: {{(orders | filter:{status_id:'6'}).length * 100 / orders.length }}%;"></span> </span> </div>
  ...
  <div class="main-content container-fluid col-xs-12 col-md-9 col-lg-9">
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        <h2 flex md-truncate class="text-bold"><?php echo lang('orders'); ?><br>
        ...
        <md-button ng-href="<?php echo base_url('orders/create') ?>" class="md-icon-button" aria-label="New">
    ...
    <md-content  class="md-pt-0">
      <ul class="custom-ciuis-list-body" style="padding: 0px;">
        <li ng-repeat="order in orders | filter: FilteredData | filter:search | pagination : currentPage*itemsPerPage | limitTo: 5" class="ciuis-custom-list-item ciuis-special-list-item lead-name">
          <ul class="list-item-for-custom-list">
            <li class="ciuis-custom-list-item-item col-md-12">
              <div class="assigned-staff-for-this-lead user-avatar"><i class="ico-ciuis-orders" style="font-size: 32px"></i></div>
              <div class="pull-left col-md-3"> <a href="<?php echo base_url('orders/order/'); ?>{{order.id}}"><strong ng-bind="order.subject"></strong></a><br>
                <small ng-bind="order.customer"></small> </div>
              <div class="col-md-9">
                <div class="col-md-3"> <span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('date')?></small><br>
                  <strong><span class="badge" ng-bind="order.date"></span></strong></span> </div>
                <div class="col-md-3"> <span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('opentill'); ?></small><br>
                  <strong><span class="badge" ng-bind="order.opentill"></span></strong></span> </div>
                <div class="col-md-3"> <span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('status'); ?></small><br>
                  <span class="label {{order.class}} label-default" ng-bind="order.status"></span> </div>
                <div class="col-md-2 text-right"> <span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('amount'); ?></small><br>
                  <strong ng-bind-html="order.total | currencyFormat:cur_code:null:true:cur_lct"></strong></span> </div>
                <div class="col-md-1">
                  <div style="margin-top: 5px;" data-toggle="tooltip" data-placement="left" data-container="body" title="" data-original-title="Created by: {{order.staff}}" class="assigned-staff-for-this-lead user-avatar"><img ng-src="<?php echo base_url('uploads/images/{{order.staffavatar}}')?>" alt="{{order.staff}}"></div>
                </div>
              </div>
            </li>
          </ul>
      ...
      <div ng-hide="orders.length < 5" class="pagination-div text-center">
        <ul class="pagination">
  ...
  <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ContentFilter">
    ...
    <md-content layout-padding="">
      <div ng-repeat="(prop, ignoredValue) in orders[0]" ng-init="filter[prop]={}" ng-if="prop != 'id' && prop != 'assigned' && prop != 'subject' && prop != 'customer' && prop != 'date' && prop != 'opentill' && prop != 'status' && prop != 'staff' && prop != 'staffavatar' && prop != 'total' && prop != 'class' && prop != 'relation' && prop != 'status_id' && prop != 'prefix' && prop != 'longid' && prop != 'relation_type'" >
