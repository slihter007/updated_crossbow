  ...
  <div  class="main-content container-fluid col-xs-12 col-md-12 col-lg-9"> 
    ...
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang('createorder') ?></h2>
        <md-switch ng-model="order_type" aria-label="Type"><strong class="text-muted"><?php echo lang('for_lead') ?></strong></md-switch>
        <md-button ng-href="<?php echo base_url('orders')?>" class="md-icon-button" aria-label="Save">
    ...
    <md-content class="bg-white" layout-padding>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker name="opentill" ng-model="opentill"></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
