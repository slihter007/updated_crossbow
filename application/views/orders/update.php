  ...
  <div ng-controller="Order_Controller" class="main-content container-fluid col-xs-12 col-md-12 col-lg-9"> <?php echo form_open('orders/update',array("class"=>"form-horizontal orderForm")); ?>
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang('updateorder') ?></h2>
        <md-button ng-href="<?php echo base_url('orders/order/{{order.id}}')?>" class="md-icon-button" aria-label="Save">
    ...
    <md-content class="bg-white" layout-padding>
      <div layout-gt-xs="row">
        ...
        <md-input-container ng-show="order.order_type == false" class="md-block" flex-gt-xs>
          ...
          <md-select required placeholder="<?php echo lang('choisecustomer'); ?>" ng-model="order.customer" name="customer" style="min-width: 200px;">
        ...
        <md-input-container>
          ...
          <md-datepicker name="created" ng-model="order.created"></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker name="opentill" ng-model="order.opentill"></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
