    ...
    <md-content class="bg-white" layout-padding>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
          ...
          <md-select required placeholder="<?php echo lang('choisecustomer'); ?>" ng-change="default_payment_method = customer.default_payment_method" ng-model="customer" name="customer" style="min-width: 200px;">
            <md-select-header>
              <md-toolbar class="toolbar-white">
                <div class="md-toolbar-tools">
                  <md-button class="md-icon-button" aria-label="Invoice" ng-disabled="true">
                  ...
                  <md-button ng-href="<?php echo base_url('customers')?>" class="md-icon-button" aria-label="Create New">
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container ng-show="!invoice_status">
          ...
          <md-datepicker md-min-date="created" name="duedate" ng-model="duedate"></md-datepicker>
        </md-input-container>
      </div>
