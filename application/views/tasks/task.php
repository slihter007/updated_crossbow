  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <md-button ng-if="task.billable != false" id="startTaskTimer" ng-show="task.timer == false && task.relation_type === 'project'" ng-hide="task.status_id == 4" ng-click='startTimerforTask()' class="md-icon-button" aria-label="Task">
        ...
        <md-button ng-if="task.billable != false" id="stopTaskTimer" ng-show="task.timer == true" ng-click='stopTimer()' class="md-icon-button" aria-label="Task">
