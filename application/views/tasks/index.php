  ...
  <div class="main-content container-fluid col-xs-12 col-md-9 col-lg-9 md-p-0">
    <md-toolbar class="toolbar-trans">
      <div class="md-toolbar-tools">
        <h2 flex md-truncate class="text-bold"><?php echo lang('tasks'); ?><br>
        ...
        <ul class="custom-ciuis-list-body" style="padding: 0px;">
          <li ng-repeat="task in tasks | filter: FilteredData | filter:search | pagination : currentPage*itemsPerPage | limitTo: 5" class="milestone-todos-list ciuis-custom-list-item ciuis-special-list-item paginationclass">
            <ul class="all-milestone-todos">
              <li class="milestone-todos-list-item col-md-12  {{task.done}}"> <span class="pull-left col-md-5"><a href="<?php echo base_url('tasks/task/')?>{{task.id}}"><strong ng-bind="task.name"></strong></a><br>
                <small ng-bind="task.relationtype"></small></span>
                <div class="col-md-7">
                  <div class="col-md-3"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('startdate'); ?> <i class="ion-ios-stopwatch-outline"></i></small><br>
                    <strong ng-bind="task.startdate"></strong></span> </div>
                  <div class="col-md-3"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('duedate'); ?> <i class="ion-ios-timer-outline"></i></small><br>
                    <strong ng-bind="task.duedate"></strong></span> </div>
                  <div class="col-md-3"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('status'); ?> <i class="ion-ios-circle-outline"></i></small><br>
                    <strong ng-bind="task.status"></strong></span> </div>
                  <div class="col-md-3 text-right"> <a ng-href="<?php echo base_url('tasks/task/') ?>{{task.id}}" class="edit-task pull-right"><i class="ion-compose"></i></a> </div>
                </div>
              </li>
            </ul>
          </li>
    ...
    <md-content>
      <md-content layout-padding="">
        ...
        <md-input-container class="md-block">
          ...
          <textarea required name="description" ng-model="task.description" placeholder="<?php echo lang('typeSomething'); ?>" class="form-control"></textarea>
        </md-input-container>
