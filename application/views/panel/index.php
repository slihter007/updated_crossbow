			...
			<md-toolbar class="toolbar-white">
				<div class="md-toolbar-tools">
					...
					<md-button ng-click="EventForm()" class="md-icon-button" aria-label="Event">
						<md-tooltip md-direction="bottom" ng-bind='lang.addevent'></md-tooltip>
						<md-icon><i class="mdi mdi-calendar-note text-muted"></i></md-icon>
					</md-button>
					<md-button ng-click="SetOnsiteVisit()" class="md-icon-button" aria-label="Onsite Visits" ng-hide="ONLYADMIN != 'true'">
								...
								<div class="hpanel stats">
									<div style="padding-top: 0px;line-height: 0.99;margin-right: 10px;" class="panel-body h-200 xs-p-0">
										<div class="col-md-12 xs-mb-20 md-pl-0" style="margin-top: -14px;">
											...
											<small><strong ng-bind='lang.todayssales'></strong></small>
										...
										<div class="stats-title"><h4 style="font-weight: 500;color: #c7cbd5;" ng-bind='lang.netcashflow'></h4></div>
											...
											<div style="height: 10px" class="progress">
											  <div style="font-size: 7px;line-height: 10px;width:{{stats.inp}}%" class="progress-bar progress-bar-success progress-bar-striped" ng-bind="stats.inp+'%'"> {{lang.incomings}}<span class="sr-only" ng-bind='lang.incomings'></span></div>
											  <div style="font-size: 7px;line-height: 10px;width:{{stats.ogp}}%" class="progress-bar progress-bar-danger progress-bar-striped" ng-bind="stats.ogp+'%'"> {{lang.outgoings}}<span class="sr-only" ng-bind='lang.outgoings'></span></div>
											</div>
											<div class="row">
												<div class="col-xs-6">
													<small class="stats-label text-uppercase text-bold text-success" ng-bind='lang.incomings'></small>
													<h4  ng-bind-html="stats.pay | currencyFormat:cur_code:null:true:cur_lct"></h4>
												</div>

												<div class="col-xs-6">
													<small class="stats-label text-uppercase text-bold text-danger" ng-bind='lang.outgoings'></small>
									...
									<div class="widget-counter-group widget-counter-group-right">
										<div class="pull-left">
											<div class="pull-left text-left">
												<h4 style="padding: 0px;margin: 0px;"><b ng-bind='lang.weeklygraphtitle'></b></h4>
												<small ng-bind='lang.weeklygraphdetailtext'></small>
											</div>
										</div>
										<div class="counter counter-big">
											...
											<div class="desc" ng-bind='lang.thisweek'></div>
										</div>
										<div class="counter counter-big">
