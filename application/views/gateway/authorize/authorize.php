			...
			<div id="Checkout" class="inline">
				...
				<form method="post" action="<?php echo base_url('gateway/pushPayment');?>">
					...
					<div class="form-group">
						...
						<input id="cdesc" name="cdesc" class="form-control" type="text" maxlength="500" value="<?php if($customer['type']===1){echo $customer['namesurname'];} else echo $invoice['company']; ?> <?php echo sprintf( lang( 'paymentfor' ), str_pad( $invoice[ 'id' ], 6, '0', STR_PAD_LEFT ) )?>">
						</input>
					</div>
					<div class="form-group">
