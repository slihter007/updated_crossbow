...
<md-content class="ciuis-body-content" ng-controller="Ticket_Controller">
	...
	<md-content ng-show="!ticketsLoader" class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
		...
		<md-content layout-padding class="bg-white" style="overflow: hidden;">
			...
			<div class="ticket-replies row">
									...
									<article class="ciuis-note-detail" ng-repeat="reply in ticket.replies">
										...
										<div class="ciuis-note-detail-body">
											<div class="text">
											  ...
											  <span ng-hide="!reply.attachment"><a class="delete-note-button pull-right" ng-href="<?php echo base_url('tickets/attachments/{{reply.attachment}}') ?>"><i class="ion-android-attach"></i></a></span>
											  </p>
											</div>
								...
								<?php echo form_open_multipart('tickets/reply/'.$ticket['id'].''); ?>
									...
									<textarea required="" name="message" ng-model="reply.message" placeholder="<?php echo lang('typeSomething'); ?>" class="form-control answer"></textarea>
									</md-input-container>
