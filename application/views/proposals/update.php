  ...
  <div ng-controller="Proposal_Controller" class="main-content container-fluid col-xs-12 col-md-12 col-lg-9"> <?php echo form_open('proposals/update',array("class"=>"form-horizontal proposalForm")); ?>
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <md-switch ng-model="proposal.proposal_type" aria-label="Type"><strong class="text-muted"><?php echo lang('for_lead')?></strong></md-switch>
    ...
    <md-content class="bg-white" layout-padding>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="proposal.created" name="opentill" ng-model="proposal.opentill"></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
