		...
		<md-content class="bg-white">
			...
			<md-toolbar class="toolbar-white">
				<div class="md-toolbar-tools">
					...
					<md-button ng-href="<?php echo base_url('appointments') ?>" class="md-icon-button" aria-label="Appointments">
						<md-tooltip md-direction="bottom"><?php echo lang('appointments') ?></md-tooltip>
						<md-icon><i class="mdi mdi-calendar text-muted"></i></md-icon>
					</md-button>
				<?php } ?>
				</div>
			</md-toolbar>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<?php if (!$this->session->userdata('other')) { ?>
					<button class="btn btn-default"><a id="eventUrl"><?php echo lang('delete')?></a></button>
				<?php } ?>
				</div>
			</div>
		</div>
