...
class Report_Model extends CI_Model {
	...
	function get_timesheet() {
		$admin = $this->isAdmin();
		$this->db->select( 'tasktimer.id, tasktimer.start, tasktimer.end, tasktimer.task_id, tasks.name, tasktimer.note, staff.staffname as staff, staff.id as staff_id, staff.staffavatar as avatar ' );
